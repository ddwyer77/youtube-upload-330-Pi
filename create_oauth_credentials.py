...
This script helps you create a new client_secrets.json file
"""
...
def create_credentials_file():
    """Create a new client_secrets.json file with user-provided credentials"""
    ...
    print("5. Give it a name like 'YouTube Shorts Uploader'")
    ...
    try:
        ...
        print("\nSuccessfully created client_secrets.json!")
        print("\nNow you need to:")
        print("1. Remove any existing token.pickle file: rm token.pickle")
        print("2. Run the authentication script: python easy_auth.py")
